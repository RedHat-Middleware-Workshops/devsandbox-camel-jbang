...
image::docs/labs/intro-cjbang/images/camel-jbang.png[width=55%]
...
image::docs/labs/intro-cjbang/images/paste-multiline.jpg[width=50%]
...
image::docs/labs/intro-cjbang/images/terminal-plus.jpg[width=50%]
...
image::docs/labs/intro-cjbang/images/terminal-one.jpg[width=40%]
...
image::docs/labs/intro-cjbang/images/court-side2-ball.jpg[width=20%]
...
image::docs/labs/intro-cjbang/images/court-clear.jpg[width=20%]
...
image::docs/labs/intro-cjbang/images/court-rally.jpg[width=35%]
