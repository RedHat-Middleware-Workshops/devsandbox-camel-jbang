...
_Camel JBang_ is a command-line interface (CLI) that helps you run, iterate, and test your _Apache Camel_ applications without complex setups. It accelerates prototyping: create, validate, and tweak flows quickly—ideal for rapid experimentation and for getting a feel of what _Camel_ can do.

image::docs/labs/intro-cjbang/images/camel-jbang.png[width=48%]
...
image::docs/labs/intro-cjbang/images/tennis-illustration.jpg[width=100%]

== Getting started

Make sure you have _Camel JBang_ installed in your environment. If not, see the link:https://camel.apache.org/manual/camel-jbang.html#_installation[Installation] section in the Camel JBang manual.
...
=== Playing the tennis game with Camel JBang
...
image::docs/labs/intro-cjbang/images/paste-multiline.jpg[width=40%]
...
*Note:* There are no dependency descriptors or extra files—_Camel JBang_ reads `player1.yaml` and runs the route.
...
image::docs/labs/intro-cjbang/images/terminal-plus.jpg[width=40%]
...
image::docs/labs/intro-cjbang/images/terminal-one.jpg[width=32%]
...
image::docs/labs/intro-cjbang/images/court-side2-ball.jpg[width=14%]

*Note:* With only one player, the ball ends up on the other side and stays there.

Before continuing, stop player1 with kbd:[Ctrl+C].
...
image::docs/labs/intro-cjbang/images/court-clear.jpg[width=14%]

Let player1 practice a bit more, then press kbd:[Ctrl+C] to stop.
...
. Stop any running routes. Press kbd:[Ctrl+C] if something is still running.
...
image::docs/labs/intro-cjbang/images/court-rally.jpg[width=26%]
...
Continue with other chapters in the workshop to see what _Camel JBang_ can do beyond this intro, and how it fits with other tools for working quickly with _Apache Camel_—from initial concepts to deployment on platforms like OpenShift.
