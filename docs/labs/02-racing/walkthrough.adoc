...
* To radio instructions to its driver to instruct
* To tidy up and leave the venue when the day ends
====
...
[NOTE]
====
- Click pass:[<span style="font-size: 35px;">↻</span>] to refresh your project file explorer.
...
The code below sets up the media coverate, with multiple cameras on track, enabling the transmission of the race to multiple media channels.
...
Your pass:[<span style="font-size:35px;">📺</span>] screen will show the track's layout:
...
For better watching we recommend you organize your terminals horizontally. If you are using VS Code or DevSpaces, you can do this with a drag and drop operation.
...
{empty} +
+
1. Lastly, in the new terminal, make sure you switch to the `lab` directory:
+
--
{copypaste}
----
...
Here we set it to pass:[<span style="font-size:35px;">🐎</span>] for *Team Cavallino Racing*.
--
=====
...
[ BOXES ]        | Sector 1| Sector 2| Sector 3|
[-------]        |---------|---------|---------|
<span style="display:inline-block;width:8ch;min-width:8ch">[🐪‾ō͡≡o˞̶</span>]        |         |         |         |
<span style="display:inline-block;width:8ch;min-width:8ch">[🐎‾ō͡≡o˞̶</span>]        |         |         |         |
</pre>
++++
...
[-------]- Grid -|---------|---------|---------|
[       ]        |         |         |         |
[       ]<span style="display:inline-block;width:8ch;min-width:7ch"> 🐪‾ō͡≡o˞̶</span>|         |         |         |
[       ]<span style="display:inline-block;width:8ch;min-width:7ch"> 🐎‾ō͡≡o˞̶</span>|         |         |         |
</pre>
++++
...
++++
<pre style="background-color: #1e1e1e; color: #d4d4d4; padding: 12px; font-family: monospace; font-size: 12px; line-height: 1.1;">
[       ]        <span style="display:inline-block;width:8ch;min-width:8ch">🔴</span>  |         |         |
[       ]        <span style="display:inline-block;width:8ch;min-width:8ch">🔴</span>  |         |         |
[       ]        <span style="display:inline-block;width:8ch;min-width:8ch">🔴</span>  |         |         |
[       ]        <span style="display:inline-block;width:8ch;min-width:8ch">🟢</span>  |         |         |
[       ]        |<span style="display:inline-block;width:8ch;min-width:8ch"> 🐪‾ō͡≡o˞̶</span> |         |         |
...
Innevitably the cost of broadcasting races isn't econically viable unless another source of income is found. For that reason we decided to upgrade the broadcast system to include advertising.
...
Have a look to the radio messages transmitted from the teams to their drivers.
