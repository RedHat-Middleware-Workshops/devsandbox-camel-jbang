...
From this point onwards, your terminal effectively becomes your TV screen pass:[<span style="font-size:35px;">📺</span>] where you'll be able to watch the race unfold.
...
{empty} +
+
1. Lastly, *pass:[<span style="font-size:25px;">VERY IMPORTANT 👀</span>]*
+
[IMPORTANT]
====
