...
_Camel JBang_ is a command-line interface (CLI) that speeds up prototyping by letting you quickly create, validate, and tweak flows without complex setup—ideal for rapid experimentation.

image::images/camel-jbang.png[width=40%]

This chapter is optional but recommended to see how _Camel JBang_ helps you work quickly with _Apache Camel_.
...
This chapter is a short introduction to _Camel JBang_ and a basic set of commands. You'll see how much you can speed up your work when you use _Camel JBang_ well.
...
image::images/crw-terminal.png[width=100%]
