...
For a **better reading experience**, you can [run the documentation in a container](#run-the-documentation-in-a-container).
...
| Option | Description |
|--------|-------------|
| **[1. Run on your local machine](#run-on-your-local-machine)** | Click a lab in the table above and follow the walkthrough on your machine. |
...
## Run the documentation in a container
